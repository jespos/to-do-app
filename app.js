function onReady() {
  ...
  function renderTheUI() {
    ...
    toDoList.textContent = ''; //each time we call the renderTheUI() function, it will add new lis to the ul. So before the forEach() function, we need to set newLi to an empty string.
